...
test_that("independent two-sample (unequal variance, default) runs", {
  ...
  res1 <- t_test_all_tidy_grouped(dat, paired = FALSE, show_table = FALSE)
  res2_1 <- t_test_all_tidy(dat_con, paired = FALSE, show_table = FALSE)
  res2_2 <- t_test_all_tidy(dat_int, paired = FALSE, show_table = FALSE)
...
test_that("paired runs", {
  ...
  res1 <- t_test_all_tidy_grouped(dat, paired = TRUE, show_table = FALSE)
  res2_1 <- t_test_all_tidy(dat_man, paired = TRUE, show_table = FALSE)
  res2_2 <- t_test_all_tidy(dat_wom, paired = TRUE, show_table = FALSE)
